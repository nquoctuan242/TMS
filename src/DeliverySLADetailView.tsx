               ...
               <div className="p-6 border-t border-gray-100">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div>
                      ...
                      />
                      <p className="text-[10px] text-gray-500 mt-1.5">Orders changing to Waiting For Pickup status before this time will be processed using the Before Cutoff rule.</p>
                    </div>
